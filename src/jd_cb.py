...
class CheckOutBot:
    def __init__(self):
        ...
        self.driver.get("https://www.jdsports.ie/XXXXX") #Input Product ID and Quantity
    ...
    def login(self, email, password):
        self.driver.get("https://www.jdsports.ie/myaccount/dashboard/")
        time.sleep(5)
    ...
    def add_product_to_cart(self, link):
        ...
        time.sleep(1)
        add_to_cart_button = self.driver.find_element_by_xpath('//*[@id="AddToCart"]/div/div[3]/button')
        add_to_cart_button.click()
        time.sleep(2)

    def checkout(self):
        self.driver.get("https://www.jdsports.ie/cart/")
        time.sleep(1)
    ...
    submit_button = self.driver.find_element_by_xpath('//*[@id="SubmitForm"]/div/div[1]/div/button')  
    submit_button.click()
...
if __name__ == "__main__":
    ...
    checkout_bot.add_product_to_cart(
        "https://www.jdsports.ie/XXXXX" #Input Product ID and Quantity
    )
