...
class CheckOutBot:
    def __init__(self):
        ...
        self.driver.get("https://www.brownthomas.com/brands/XXXXX/XXXXX") #Input Product Brand and Product ID + Quantity
    ...
    def login(self, email, password):
        self.driver.get("https://www.brownthomas.com/login/?original=%2Faccount%2F")
        time.sleep(5)
    ...
    def checkout(self):
        self.driver.get("https://www.brownthomas.com/cart/")
        time.sleep(1)
...
if __name__ == "__main__":
    ...
    checkout_bot.add_product_to_cart(
        "https://www.brownthomas.com/XXXXX" #Input Product ID and Quantity
    )
